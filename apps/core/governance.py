...
Kenya keeps the full county → constituency → ward tree. Other countries
ship first-level units; deeper units appear when a project record names them.
"""
...
COUNTRIES = {
    ...
    "JO": {
        ...
        "labels": {
            ...
            "track": "Track my governorate",
            "whole": "Whole governorate",
            "assembly": "municipal or governorate council",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In Jordan, Law No. 47 of 2007 on access to information lets you ask a public body for records. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the Information Council is the national oversight office."
            ),
        },
    },
    "LB": {
        ...
        "labels": {
            ...
            "level2_plural": "districts",
            "level3": "Municipality",
            "level3_plural": "municipalities",
            "track": "Track my governorate",
            "whole": "Whole governorate",
            "assembly": "municipal council",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In Lebanon, Law 28/2017 on the right of access to information lets you ask a public body for records. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the National Anti-Corruption Commission oversees the law."
            ),
        },
    },
    "PS": {
        ...
        "law": {
            "title": "Request information in writing",
            "body": (
                "Write to the public body that holds the file. Name the project and where to send the reply. "
                "The Independent Commission for Human Rights is a civic oversight route. This is not legal advice."
            ),
        },
    },
    "BR": {
        ...
        "labels": {
            ...
            "level2_plural": "municipalities",
            "level3": "District",
            "level3_plural": "districts",
            "track": "Track my state",
            "whole": "Whole state",
            "assembly": "assembleia legislativa or câmara municipal",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In Brazil, the Lei de Acesso à Informação (Law 12.527/2011) lets you ask a public body for records. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the Controladoria-Geral da União (CGU) oversees the law at federal level."
            ),
        },
    },
    "HT": {
        ...
        "labels": {
            "level1": "Department",
            "level1_plural": "departments",
            "level2": "Arrondissement",
            "level2_plural": "arrondissements",
            "level3": "Commune",
            "level3_plural": "communes",
            "track": "Track my department",
            "whole": "Whole department",
    ...
    "MX": {
        ...
        "labels": {
            ...
            "track": "Track my state",
            "whole": "Whole state",
            "assembly": "congreso estatal or ayuntamiento",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In Mexico, the General Law of Transparency and Access to Public Information lets you ask a public body for records. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the national or state transparency institute (INAI or the local institute) is the oversight office."
            ),
        },
    },
    "CO": {
        ...
        "labels": {
            ...
            "level2": "Municipality",
            "level2_plural": "municipalities",
            "level3": "Corregimiento",
            "level3_plural": "corregimientos",
            "track": "Track my department",
            "whole": "Whole department",
            "assembly": "asamblea departamental or concejo municipal",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In Colombia, Law 1712 of 2014 on transparency and the right of access to public information lets you ask a public body for records. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the Procuraduría General and the national transparency authority are further civic routes."
            ),
        },
    },
    "PT": {
        ...
        "labels": {
            ...
            "level2_plural": "municipalities",
            "level3": "Parish",
            "level3_plural": "parishes",
            "track": "Track my district",
            "whole": "Whole district",
            "assembly": "assembleia municipal",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In Portugal, Law No. 26/2016 on access to administrative documents lets you ask a public body for records. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the Comissão de Acesso aos Documentos Administrativos (CADA) is the national oversight office."
            ),
        },
    },
    "FR": {
        ...
        "labels": {
            ...
            "track": "Track my region",
            "whole": "Whole region",
            "assembly": "conseil régional or départemental",
        },
        "law": {
            "title": "Request information in writing",
            "body": (
                "In France, the Code des relations entre le public et l’administration lets you ask a public body for administrative documents. "
                "Name the project and where to send the reply. "
                "If there is no useful answer, the Commission d’accès aux documents administratifs (CADA) is the national oversight office."
            ),
        },
    },
}
